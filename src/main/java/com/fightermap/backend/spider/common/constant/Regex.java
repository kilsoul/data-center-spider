...
public class Regex {
    ...
    public static class Lianjia {
        ...
        public static final String DISTRICT = "(http[s]?://[\\w.\\w]*)/"+SECOND_HAND_KEY+"/\\w+("+PAGE_KEY+"[0-9]+)?/?";
        public static final String POSITION = "(http[s]?://[\\w.\\w]*)/"+SECOND_HAND_KEY+"/\\w+/\\w+("+PAGE_KEY+"[0-9]+)?/?";
